...
$jwt:=cs._JWT.new({privateKey: $secretKey; payload: {sub: "1234567890"; name: "John Doe"; iat: 1516239022}})
$validToken:=$jwt.generate()
ASSERT($jwt.validate($validToken; $secretKey))

// Test case 2: Decode an invalid token
$jwt:=cs._JWT.new({privateKey: $secretKey})
...
ASSERT(Not($jwt.validate($invalidToken; $secretKey)))
...
ASSERT(Not($jwt.validate($validToken; $secretKey)))
