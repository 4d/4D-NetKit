...
Function next() : Boolean
	...
	If (Length:C16($URL)>0)
		var $bIsOK : Boolean
		$bIsOK:=This:C1470._getMailList($URL)
		If ($bIsOK)
...
Function previous() : Boolean
	...
	// [Private]
Function _getMailList($inURL : Text) : Boolean
	...
	If ($response#Null:C1517)
		...
		For each ($object; $result)
			This:C1470.mails.push(Super:C1706._cleanResponseObject($object))
		End for each 
